        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="glass-btn px-5 py-2.5 rounded-xl text-xs uppercase tracking-wider cursor-pointer"
            >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16 grid grid-cols-1 lg:grid-cols-12 items-center gap-12 relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          >
            <button
              onClick={() => setShowAuthModal(true)}
              className="glass-btn-primary px-8 py-4 rounded-2xl text-xs uppercase tracking-widest flex items-center justify-center gap-2 cursor-pointer hover:scale-[1.02] active:scale-98"
            >
            ...
            <button
              onClick={onEnter}
              className="glass-btn px-8 py-4 rounded-2xl text-xs uppercase tracking-widest flex items-center justify-center gap-2 cursor-pointer hover:scale-[1.02] active:scale-98"
            >
                ...
                <div className="flex flex-col gap-5 h-full flex-1 justify-between">
                      ...
                      {!user ? (
                        <div className="flex flex-col gap-2 mt-1">
                          ...
                          <button
                            ...
                            className="glass-btn w-full py-2.5 px-3 rounded-lg text-[11px] flex items-center justify-center gap-2 cursor-pointer shadow-sm group/btn"
                          >
                          ...
                          <form onSubmit={handleEmailSignIn} className="flex gap-1.5">
                            ...
                            <button
                              ...
                              className="glass-btn-primary px-4 rounded-lg text-[11px] flex items-center justify-center gap-1 cursor-pointer disabled:opacity-50"
                            >
                        ...
                        <div className="mt-0.5 p-2 rounded-lg bg-[var(--fern)]/5 border border-[var(--fern)]/15 flex justify-between items-center text-xs">
                          ...
                          <button 
                            ...
                            className="text-[9px] font-bold text-[var(--text-muted)] hover:text-white transition-colors cursor-pointer"
                          >
                            Sign Out
                          </button>
                        </div>
                  ...
                  <div className="flex flex-col gap-2 mt-4">
                    <button
                      ...
                      className="glass-btn-primary w-full py-4 px-6 rounded-2xl text-xs tracking-wider uppercase flex items-center justify-center gap-2 cursor-pointer hover:scale-[1.01]"
                    >
